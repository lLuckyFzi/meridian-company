...
function Header() {
  ...
  return (
    <nav
      className={twMerge(
        "flex justify-between items-center fixed pl-[120px] z-99 right-0 left-0 top-0 duration-300 max-lg:p-14 max-lg:py-5 max-sm:px-4",
    ...
    >
        ...
        {[
          ...
          return (
            <Link
              ...
              href={item.href}
              className={twMerge(
                "relative px-2 transition-colors duration-300 text-white",
                scrolled && "text-gray-700",
      ...
      <div className="max-lg:hidden">
        <PrimaryButton className="!px-8">Mulai Sekarang</PrimaryButton>
      </div>
      ...
      >
        ...
        <PrimaryButton className="!absolute !bottom-0 !left-0 !right-0">
          Hubungi Kami
        </PrimaryButton>
      </div>
    </nav>
