...
function ServicesCard(props: ServicesCardProps) {
  const { img, icon, title, description, activeId, onHover } = props;

  return (
    <div className="relative overflow-hidden h-full max-md:h-[500px] border-b border-b-white" onMouseEnter={onHover}>
